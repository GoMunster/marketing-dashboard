  ...
  return (
    <div className="p-4 max-w-7xl mx-auto">
      ...
      <div className="mb-6 flex gap-2">
        ...
        <button className="bg-gray-200 px-3 py-1 rounded">Clear Filters</button>
      </div>
      ...
      {/* Lead Statistics */}
      <div className="mb-6">
        <h2 className="text-lg font-semibold mb-2">Lead Statistics</h2>
        <div className="space-y-2">
          <div>
            <div className="font-medium">Leads</div>
            <div className="text-xl">{leadData.totalLeads}</div>
          </div>
      ...
      <div className="space-y-6">
        <div>
          <h2 className="text-lg font-semibold mb-2">Leads By Origin</h2>
        ...
        <div>
          <h2 className="text-lg font-semibold mb-2">Leads by Job Title</h2>
          <div className="h-64 border rounded p-4">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie
        ...
        <div>
          <h2 className="text-lg font-semibold mb-2">Leads by Promo (Current VS Previous)</h2>
          <div className="h-64 border rounded p-4">
            <ResponsiveContainer width="100%" height="100%">
